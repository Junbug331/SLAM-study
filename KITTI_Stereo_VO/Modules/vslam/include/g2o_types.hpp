#ifndef VSLAM_G2O_TPYES_HPP
#define VSLAM_G2O_TPYES_HPP
...
namespace vslam
{
    ...
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
        EdgeProjection(const Mat33 &K, const SE3d &cam_ext)
            : _K(K)
        {
            _cam_ext = cam_ext;
        }
        ...
        virtual void computeError() override
        {
            ...
            SE3d T = v0->estimate(); // T : world -> cam
